"""Upload the contents of your Output folder to Dropbox.
This is a quick edit from Dropbox example app for API v2.
"""
...
parser = argparse.ArgumentParser(description='Sync ~/outuput to Dropbox')
parser.add_argument('folder', nargs='?', default='Markov',
                    help='Folder name in your Dropbox')
parser.add_argument('rootdir', nargs='?', default=output_directory,
                    help='Local directory to upload')
parser.add_argument('--token', default=TOKEN,
                    help='Access token '
                    '(see https://www.dropbox.com/developers/apps)')
parser.add_argument('--yes', '-y', action='store_true', default='-y',
